// Comprehensive 5-letter English word list for guess validation.
// ~3000+ common words — covers virtually anything a player would reasonably type.
// Sourced from common English vocabulary + standard Wordle guess list.
...
export const FIVE_LETTER_WORDS: string[] = [
  ...
  "ditto","ditty","diver","dizzy","dodge","dodgy","doing","dolly","donor","donut",
  ...
  "winey","wiper","wired","wiser","wispy","witch","witty","woken","woman","women",
  ...
  // Tech / event-friendly additions (for a college hackathon vibe)
  "cloud","coder","cyber","debug","hacks","linux","macro","pixel","proxy","query",
  "quirk","relay","rover","synth","token","unify","viral","weave","hover","logic",
];
